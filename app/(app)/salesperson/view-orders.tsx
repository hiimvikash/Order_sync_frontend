                  ...
                  <View style={styles.section}>
                    ...
                    {selectedOrder.partialPayment ? (
                      <View style={styles.sectionContent}>
                        <Text style={styles.infoText}>
                          Advance: ₹
                          {selectedOrder.partialPayment.initialAmount.toLocaleString()}
                        </Text>
                        <Text style={styles.infoText}>
                          Balance Amount: ₹
                          {selectedOrder.partialPayment.remainingAmount.toLocaleString()}
                        </Text>
                        <Text style={styles.infoText}>
                          Due Date:{" "}
                          {formatDate(selectedOrder.partialPayment.dueDate)}
                        </Text>
                        <Text style={styles.infoText}>
                          Payment Status:{" "}
                          {selectedOrder.partialPayment.paymentStatus}
                        </Text>
                      </View>
                    ) : (
                      <Text style={styles.infoText}>
