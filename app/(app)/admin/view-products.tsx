...
const ProductDetails = memo(({ product }: { product: Product }) => (
  <ScrollView style={styles.detailsContainer}>
    ...
    >
      ...
      {(() => {
            const [firstLine, secondLine] = formatProductName(product.name, 22);
            return (
              <>
                <Text style={styles.productName}>{firstLine}</Text>
                {secondLine && (
                  <Text style={styles.productName}>{secondLine}</Text>
                )}
              </>
            );
          })()}
      ...
      >
        <View style={styles.productHeader}>
          ...
          <View style={styles.stockBadge}>
            <Text style={styles.stockText}>Stock: {item.inventoryCount}</Text>
          </View>
        </View>
